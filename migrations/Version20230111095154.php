 ...
 */
final class Version20230111095154 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE crus ADD cepage_id INT NOT NULL, DROP cepage');
        $this->addSql('ALTER TABLE crus ADD CONSTRAINT FK_C4E696FA8AC6BB8A FOREIGN KEY (cepage_id) REFERENCES cepage (id)');
        $this->addSql('CREATE INDEX IDX_C4E696FA8AC6BB8A ON crus (cepage_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_C4E696FA8AC6BB8A ON crus');
        $this->addSql('ALTER TABLE crus ADD cepage VARCHAR(30) NOT NULL, DROP cepage_id');
    }
}

 ...
 */
final class Version20230102092846 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fiche_partenaire ADD utilisateur_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fiche_partenaire DROP utilisateur_id');
    }
}

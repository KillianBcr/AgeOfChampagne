...
class Utilisateur implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function getPnomUtil(): ?string
    {
        return $this->pnomUtil;
    }

    public function setPnomUtil(string $pnomUtil): self
    {
        $this->pnomUtil = $pnomUtil;
    ...
    public function setTelUtil(string $telUtil): self
    {
